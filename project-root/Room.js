...
class Room extends Phaser.Scene {
  ...
  createSpreadOutHallways(
    ...
    for (let y = -200; y <= 200; y += wallTileSize) {
      this.walls
        .create(centerX - 300, centerY + y, "wall")
        .setDisplaySize(wallTileSize, wallTileSize)
        .refreshBody();
    }
    ...
    for (let x = -400; x <= 400; x += wallTileSize) {
      this.walls
        .create(centerX + x, centerY - 300, "wall")
        .setDisplaySize(wallTileSize, wallTileSize)
        .refreshBody();
    }
    ...
    for (let x = 0; x <= 200; x += wallTileSize) {
      this.walls
        .create(centerX + 450, centerY - 450 + x, "wall")
        .setDisplaySize(wallTileSize, wallTileSize)
        .refreshBody();
    }
    for (let y = 0; y <= 150; y += wallTileSize) {
      this.walls
        .create(centerX + 350 + y, centerY - 450, "wall")
        .setDisplaySize(wallTileSize, wallTileSize)
        .refreshBody();
    }
    ...
    for (let x = 0; x <= 200; x += wallTileSize) {
      this.walls
        .create(centerX - 450, centerY + 350 + x, "wall")
        .setDisplaySize(wallTileSize, wallTileSize)
        .refreshBody();
    }
    for (let y = 0; y <= 150; y += wallTileSize) {
