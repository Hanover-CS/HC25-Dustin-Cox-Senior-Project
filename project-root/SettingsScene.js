...
class SettingsScene extends Phaser.Scene {
  ...
  create() {
    ...
    const panel = this.add
      ...
      .setOrigin(0.5)
      .setScale(1.5); // Adjust scale if needed
    ...
    this.add
      .text(this.cameras.main.centerX, 220, "Settings", {
        fontSize: "32px",
        color: "#000000",
        fontFamily: "Arial",
      })
    ...
    //volume label
    this.add
      .text(this.cameras.main.centerX, 320, "Volume", {
        fontSize: "24px",
        color: "#000000",
        fontFamily: "Arial",
      })
    ...
    const sliderRect = this.add.rectangle(
      this.cameras.main.centerX,
      trackY, // Centered X, Y aligned with slider
      220,
      40, // Rectangle slightly larger than slider width and height
      0x000000,
      0.7,
    );
    ...
    const closeButton = this.add
      .text(this.cameras.main.centerX, 600, "Close", {
        fontSize: "24px",
        color: "#ffffff",
        fontFamily: "Arial",
      })
