...
class mainMenuScene extends Phaser.Scene {
  ...
  create() {
    ...
    const playButton = this.add
      .image(this.cameras.main.centerX, 400, "playButton")
      .setInteractive(
        new Phaser.Geom.Rectangle(0, 50, 300, 90),
    ...
    this.add
      .text(this.cameras.main.centerX, 400, "Play", {
        fontFamily: "Caesar Dressing",
        fontSize: "32px",
        fill: "#FFFFFF",
      })
    ...
    const settingsButton = this.add
      .image(this.cameras.main.centerX, 500, "settingsButton")
      .setInteractive(
        new Phaser.Geom.Rectangle(0, 50, 300, 90),
        Phaser.Geom.Rectangle.Contains,
      )
    ...
    this.add
      .text(this.cameras.main.centerX, 500, "Settings", {
        fontFamily: "Caesar Dressing",
        fontSize: "32px",
        fill: "#FFFFFF",
      })
