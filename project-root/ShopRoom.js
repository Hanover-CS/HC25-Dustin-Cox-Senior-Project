...
class ShopRoom extends Phaser.Scene {
    ...
    createDoorways(roomWidth, roomHeight) {
        ...
        this.physics.add.overlap(this.player, this.doorTop, () => this.scene.start('RegularRoom1'));
        this.physics.add.overlap(this.player, this.doorBottom, () => this.scene.start('RegularRoom2'));
        this.physics.add.overlap(this.player, this.doorLeft, () => this.scene.start('HubRoom'));
        this.physics.add.overlap(this.player, this.doorRight, () => this.scene.start('BossRoom'));
    }
}
