class ShopRoom extends Phaser.Scene {
    ...
    addBoxes(centerX, centerY, roomWidth, roomHeight) {
        ...
        this.boxes.create(centerX - roomWidth / 2 + boxSize, centerY + roomHeight / 2 - boxSize, 'box').setOrigin(0.5);
        this.boxes.create(centerX + roomWidth / 2 - boxSize, centerY + roomHeight / 2 - boxSize, 'box').setOrigin(0.5);
        ...
        for (let x = startX; x <= centerX + roomWidth / 2 - boxSize; x += boxSize) {
            this.boxes.create(x, centerY - roomHeight / 2 + boxSize, 'box').setOrigin(0.5);
        }
    }
    ...
    addCounter(centerX, centerY, roomWidth, roomHeight) {
        ...
        for (let x = counterStartX; x < centerX + roomWidth / 2; x += counterWidth) {
